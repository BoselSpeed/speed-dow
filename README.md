...
- **خطوات التثبيت** (`src/components/InstallGuideModal.tsx`): لوحة (Modal) تعرض خطوات تعطيل Play Protect وتنصيب الـ APK تلقائيًا عند أول دخول لأي زائر (كافة الأجهزة). يمكن للزائر إغلاقها بزر «فهمت، أُكمل»، ويُحفظ قرار الإغلاق في LocalStorage، ويتاح دائمًا زر «إعادة عرض خطوات التثبيت» أسفل بطاقة التحميل.

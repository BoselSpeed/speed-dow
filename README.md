...
- المربعات معروضة عبر مكوّن `src/components/AdSlot.tsx` باستخدام `iframe srcdoc` لعزل `atOptions` لكل موضع، مع عنوان «إعلان» — حاليًا موضع أسفل بطاقة التحميل وموضعان يحيطان بقسم «آخر التحديثات».

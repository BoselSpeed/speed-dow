...
export default function DownloadWarning() {
  ...
  return (
    <section className="mx-auto max-w-4xl px-4 sm:px-6">
      <div
        className="card rounded-2xl border-l-4 p-6"
        style={{ backgroundColor: 'var(--color-surface)', borderColor: '#f59e0b', borderLeftColor: '#f59e0b' }}
      >
        <div className="mb-4 flex items-center gap-3">
          <svg className="h-7 w-7 shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="#f59e0b" aria-hidden="true">
            <path
              strokeLinecap="round"
